...
get_header();
$thumbail_url = wp_get_attachment_url( get_post_thumbnail_id( $post->ID ) );
...
<!-- FEATURE IMAGE
	...
	<section class="feature-image" style="background: url('<?php echo $thumbail_url; ?>') no-repeat; background-size: cover;" data-type="background" data-speed="2">
		<h1><?php the_title(); ?></h1>
	</section>
	<?php		
	} else { // fallback img ?>
